...
void main() {
  testWidgets('assistant drawer is hidden by default and preserves input state', (
    WidgetTester tester,
  ) async {
    ...
    expect(find.byKey(const ValueKey('assistant-drawer-close')), findsNothing);
    ...
    expect(find.byKey(const ValueKey('assistant-drawer-close')), findsOneWidget);
